...
extui.language.defaultFile = [[{
	"eng": {
		...
		"data": {
			...
			"buffcount": "Displayed Amount",
			"buffcountDesc": "Amount of buffs displayed",
			"buffdir": "Flow Direction Right/Left",
			"buffdirDesc": "[Off] Left->Right [On] Right->Left",
			"buffdirtb": "Flow Direction Bottom/Top",
			"buffdirtbDesc": "[Off] Top->Bottom [On] Bottom->Top",
	...
	"ger": {
		...
		"data": {
			...
			"buffcount": "Angezeigte Menge",
			"buffcountDesc": "Menge von buffs die angezeigt wird",
			"buffdir": "Flow Richtung Rechts/Links",
			"buffdirDesc": "[Aus] Links->Rechts [An] Rechts->Links",
			"buffdirtb": "Flow Direction Unten/Oben",
			"buffdirtbDesc": "[Off] Oben->Unten [On] Unten->Oben",
	...
	"jp": {
		...
		"data": {
			...
			"buffcount": "表示された量",
			"buffcountDesc": "表示されるバフの量",
			"buffdir": "流れ方向右/左",
			"buffdirDesc": "[オフ]左->右 [オン]右->左",
			"buffdirtb": "流れ方向下/上",
			"buffdirtbDesc": "[オフ] 上->下 [オン] 下->上",
	...
	"ch": {
        ...
        "data": {
			...
			"buffcount": "显示的金额",
			"buffcountDesc": "显示的增益量",
			"buffdir": "流向右/左",
			"buffdirDesc": "[关闭]左->右 [开]右->左",
			"buffdirtb": "流向底部/顶部",
			"buffdirtbDesc": "[关闭] 顶部->底部 [开] 底部->顶部",
	...
	"por": {
		...
		"data": {
			...
			"buffcount": "Valor exibido",
			"buffcountDesc": "Quantidade de buffs exibidos",
			"buffdir": "Direção dos buffs Direita/Esquerda",
			"buffdirDesc": "[Desligado] Esquerda->Direita [Ligado] Direita->Esquerda",
			"buffdirtb": "Direção dos buffs Inferior/Superior",
			"buffdirtbDesc": "[Desligado] Superior->Inferior [Ligado] Inferior->Superior",
	...
	"pl": {
		...
		"data": {
			...
			"buffcount": "Wyswietlana kwota",
			"buffcountDesc": "Wyswietlona liczba wzmocnien",
			"buffdir": "Kierunek przepływu Prawo/Lewo",
			"buffdirDesc": "[Wyłącz] Lewo-> Prawo [Włącz] Prawo-> Lewo",
			"buffdirtb": "Kierunek przepływu Dół/Góra",
			"buffdirtbDesc": "[Wyłącz] Góra-> Dół [Włącz] Dół-> Góra",
