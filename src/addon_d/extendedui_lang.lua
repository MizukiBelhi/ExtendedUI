...
extui.language.defaultFile = [[{
	"eng": {
		...
		"data": {
			...
			"visHover": "Make visible on hover",
	...
	"por": {
		...
		"data": {
			...
			"visHover": "Visível ao passar o mouse",
	...
	"pl": {
		...
		"data": {
			...
			"visHover": "Widoczne po najechaniu mysza",
